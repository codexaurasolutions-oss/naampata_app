      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', padding: 24 }}>
        ...
        <View className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm mb-6">
          <FadeInView delay={80} direction="up">
            <View className="mb-4">
              <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2">Full Name</Text>
              <View className="bg-slate-50 flex-row items-center rounded-2xl px-4 py-4 border border-transparent">
          ...
          <FadeInView delay={140} direction="up">
            <View className="mb-4">
              <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2">Phone Number</Text>
              <View className="bg-slate-50 flex-row items-center rounded-2xl px-4 py-4 border border-transparent">
          ...
          <FadeInView delay={260} direction="up">
            <View className="mb-4">
              <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2">Password</Text>
              <View className="bg-slate-50 flex-row items-center rounded-2xl px-4 py-4 border border-transparent">
          ...
          <FadeInView delay={320} direction="up">
            <View className="mb-6">
              <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2">Re-type Password</Text>
              <View className="bg-slate-50 flex-row items-center rounded-2xl px-4 py-4 border border-transparent">
                <Icon name="lock" size={20} color="#CBD5E1" />
                <TextInput
          ...
          <FadeInView delay={380} direction="up">
            <View className="mb-4">
              <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-2">I want to</Text>
          ...
          <FadeInView delay={420} direction="up">
            <TouchableOpacity
          ...
          <FadeInView delay={460} direction="up">
            <TouchableOpacity
          ...
          <FadeInView delay={540} direction="up">
            <TouchableOpacity
          ...
          <FadeInView delay={580} direction="up">
